import { Geisha, GeishaSetKey, ItemCard } from "game-shared-types"
...
export function getItemIconDefinitionByType(itemType: string, geishaSet: GeishaSetKey = 'default'): ItemIconDefinition {
    if (geishaSet === 'default' && ginzaItemDefinitions[itemType]) {
        return ginzaItemDefinitions[itemType];
    }
...
export function getItemCardImage(card: ItemCard, geishaSet: GeishaSetKey = 'default'): string {
    return card.itemImageUrl?.trim() || getGeishaCardImageById(card.geishaId, geishaSet);
}

export function getItemCardLabel(card: ItemCard, geishaSet: GeishaSetKey = 'default'): string {
    return card.itemLabel?.trim() || getGeishaNameById(card.geishaId, geishaSet);
}

export function getItemIconDefinitionForCard(card: ItemCard, geishaSet: GeishaSetKey = 'default'): ItemIconDefinition {
