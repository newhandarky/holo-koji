...
This project is indexed by GitNexus as **holo-koji** (2201 symbols, 3165 relationships, 67 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/holo-koji/context` | Codebase overview, check index freshness |
| `gitnexus://repo/holo-koji/clusters` | All functional areas |
| `gitnexus://repo/holo-koji/processes` | All execution flows |
| `gitnexus://repo/holo-koji/process/{name}` | Step-by-step execution trace |
